...
public abstract class Scene {
    ...
    public Map<String, Entity3D> getWorldPosMap() {return worldPosMap;}
    public List<Entity2D> getScreenEntities() {return screenEntities;}
    public List<Entity3D> getWorldEntities() {
        List<Entity3D> unpacked = new ArrayList<>();
    ...
    public void addWorldEntity(Entity3D e, String groupName) {
    ...
    public void processRemovals() {
        for (String id : toRemove) {
            Entity3D e = worldEntityMap.get(id);
            if (e == null) continue;
    ...
    private void registerEntity(Entity3D e) {
        worldEntityMap.put(e.getID(), e);
        worldPosMap.put(e.x + ":" + e.y + ":" + e.z, e);
    }

    private void unregisterEntity(Entity3D e) {
        worldEntityMap.remove(e.getID());
        worldPosMap.remove(e.x + ":" + e.y + ":" + e.z);
    }

    public void removeWorldEntity(String id) {toRemove.add(id);}
